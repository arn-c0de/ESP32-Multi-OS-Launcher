...
#define LAUNCHER_FONT_FIRST_CHAR 32
#define LAUNCHER_FONT_LAST_CHAR 127
#define LAUNCHER_FONT_WIDTH 5
#define LAUNCHER_FONT_HEIGHT 8

static const uint8_t s_launcher_font_5x7[] = {
